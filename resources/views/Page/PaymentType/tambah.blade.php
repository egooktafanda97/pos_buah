    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Add Payment Type</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Add Payment Type</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
            ...
            <h6 class="mb-0 text-uppercase">Add Payment Type</h6>
            <hr />
                    ...
                    <form action="{{ route('paymenttype.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Enter payment type name" value="{{ old('name') }}" required>
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="description" name="description"
                                placeholder="Enter payment type description" value="{{ old('description') }}">
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
